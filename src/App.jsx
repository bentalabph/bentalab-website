...
function App() {
  ...
  return <div className="site-shell">
    ...
    <main>
      ...
      <section className="product-band"><div className="section product-grid"><div className="product-mark"><div className="product-icon" style={{background:'#fff', padding:'4px'}}><img src="/BentaBoss-logo.png" alt="BentaBoss logo" style={{width:'100%', height:'100%', objectFit:'contain', borderRadius:'inherit'}} /></div><span>THE FIRST BENTALAB PRODUCT</span><h2>BentaBoss<br /><em>Integrated POS &amp; Accounting</em></h2><p>BentaBoss brings essential sales, inventory, accounting, and reporting tools together in one practical desktop application.</p><Button href="#features" secondary>Explore BentaBoss</Button></div><div className="product-points">{[['01','POS and sales recording'],['02','Inventory and stock activity'],['03','Customer balances and expenses'],['04','Accounting records and reports'],['05','Audit trail and data management'],['06','PDF / Excel / CSV exports']].map(([n,t]) => <div key={n}><span>{n}</span><strong>{t}</strong></div>)}</div></div></section>
